...
export const SETTINGS_REGISTRY: SettingDesc[] = [
  ...
  },
  {
    ...
    why: 'On because chores should just finish. The first time it does each kind of thing, a popup asks you; turn off Full autonomy below if you want dangerous things to always ask.',
  ...
  },
  {
    ...
    what: "When on, and 'Run commands' is set to Always allow, InboxScout does not stop to ask before dangerous commands — deleting files, formatting, shutting down, changing passwords, payments. Everything still shows in the Assistant log.",
    why: 'On, so chores and connected agents finish without interruptions — complete control out of the box. Turn it off if you would rather be asked before anything drastic.',
    who: 'Anyone who wants a last "are you sure?" before drastic actions.',
    caution: 'With this on, a mistake by the AI can delete files or change your system with no chance to say no.',
    kind: 'toggle',
    options: yesNo('On — never ask, even for dangerous commands (default)', 'Off — always ask before dangerous commands'),
